...
qa[141] = ["gitでｲﾝﾃﾞｯｸｽにｽﾃｰｼﾞﾝｸﾞされていないﾌｧｲﾙ達のいる場所は",
           "ﾜｰｸﾂﾘｰ",
...
qa[70] = ["Linuxでﾃﾞｨﾚｸﾄﾘを削除するｺﾏﾝﾄﾞは",
          "rm -r",
          "70_23/94.02-04.ﾌｧｲﾙ操作_"];

qa[69] = ["Linuxでﾃﾞｨﾚｸﾄﾘやﾌｧｲﾙをｺﾋﾟｰするｺﾏﾝﾄﾞは",
          "cp=Copy(ｺﾋﾟｰ)",
...
qa[67] = ["Linuxでﾌｧｲﾙやﾃﾞｨﾚｸﾄﾘを移動するｺﾏﾝﾄﾞは",
          "mv=Move(ﾑｰﾌﾞ)",
          "67_23/94.02-04.ﾌｧｲﾙ操作_"];

qa[66] = ["Linuxのｺﾏﾝﾄﾞ[mv b c]で移動先にﾃﾞｨﾚｸﾄﾘがない場合は",
          "ﾃﾞｨﾚｸﾄﾘbが移動し、ﾃﾞｨﾚｸﾄﾘcに名前が変わる",
          "66_23/94.02-04.ﾌｧｲﾙ操作_"];

qa[65] = ["Linuxのｺﾏﾝﾄﾞ[mv b c]で移動先にﾃﾞｨﾚｸﾄﾘcがある場合は",
         "ﾃﾞｨﾚｸﾄﾘｃの中に、ﾃﾞｨﾚｸﾄﾘｂが移動する",
         "65_23/94.02-04.ﾌｧｲﾙ操作_"];

qa[64] = ["Linuxのｺﾏﾝﾄﾞ[mv b c]で移動先ﾃﾞｨﾚｸﾄﾘがc/bである場合は",
         "ﾃﾞｨﾚｸﾄﾘｃが重複するためｴﾗｰ表示がでる",
         "64_23/94.02-04.ﾌｧｲﾙ操作_"];

qa[63] = ["Linuxのｺﾏﾝﾄﾞ[mv tmp/c workspace/tmp]でﾃﾞｨﾚｸﾄﾘがworkspace/tmpまでの場合は",
...
qa[15] = ["JavaScriptの文法で意味を持つ記号を文字列として扱う記号の名称は",
          "ｴｽｹｰﾌﾟｼｰｹﾝｽ",
