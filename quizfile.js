...
qa[180] = ["let cost=100をﾃﾝﾌﾟﾚｰﾄﾘﾃﾗﾙ使った記述は",
           "%60%24%7Bcost%7D%E5%86%86%60",
           "180_14/94.3-06.HubotとSlackｱﾀﾞﾌﾞﾀ_%60(ﾊﾞｯｸｸｫｰﾃﾝｼｮﾝ)で囲むと文字列に${変数}を組込める"];

qa[179] = ["様々な文字列を一つの文字列で表現する表記法は",
           "正規表現",
           "179_14/94.3-06.HubotとSlackｱﾀﾞﾌﾞﾀ_(例 私は.です。など)ﾒﾀ文字%28%5C.+%5C%5E+%5C%24+%5C%5B+%5C%5D+%5C%2A+%5C%2B+%5C%3F+%5C%7C+%5C%28+%5C%29%29使って表す。"];
...
qa[174] = ["配列 lots=[11,22,33]からﾗﾝﾀﾞﾑに1つ選びlotへ代入するｺｰﾄﾞは",
           "lot = lots[Math.floor(Math.random() * lots.length)];",
           "174_14/94.3-07.HubotとSlackｱﾀﾞﾌﾟﾀ_Math.floor=切捨。 Math.random()=乱数生成。lots.length=3個。lots[ｲﾝﾃﾞｯｸｽ]を作っている"];

qa[173] = ["Slackでｿｰｽｺｰﾄﾞをｼﾝﾀｯｸｽﾊｲﾗｲﾄ(可視性のため色や字体を強調)と行番号で投稿する機能は",
           "ｽﾆﾍﾟｯﾄ",
           "173_14/94.3-06.Slackのﾎﾞｯﾄ開発_⚡ﾏｰｸ「ｺｰﾄﾞまたはﾃｷｽﾄのｽﾆﾍﾟｯﾄを作成する」から使える"];
